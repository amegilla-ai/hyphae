...
## Connections App — Evidence Base & Design Implications

This report summarises the key research papers informing the Connections app, what each paper found, and what that means for how we build the app.
...
*Document version 1.3 — compiled for Connections app open source project.*
